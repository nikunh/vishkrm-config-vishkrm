...
# Vishkrm Configuration Utility - Verification Module
...
run_full_verification() {
    ...
    if [ -f "/home/vishkrm/.ohmyzsh_source_load_scripts/.go-env.zshrc" ]; then
        source "/home/vishkrm/.ohmyzsh_source_load_scripts/.go-env.zshrc" 2>/dev/null || true
    fi
